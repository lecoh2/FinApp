...
using FinApp.Infra.Data.Tests.Context;
...
namespace FinApp.Infra.Data.Tests.Fact
{
...
DateOnly.FromDateTime(DateTime.Now))
                .RuleFor(m => m.Valor,
f => (double)f.Random.Decimal(10, 1000))
                .RuleFor(m => m.Tipo,
f => f.PickRandom<TipoMovimentacao>());

            _unitOfWork = new UnitOfWork(TestContext.CreateDataContext());
                }
        [Fact(
           DisplayName = "Adicionar movimentação com sucesso  no banco de dados."
        ...
        public async Task AdicionarMovimentacaoComSucesso()
        {
            ...
            var registro = await _unitOfWork.MovimentacaoRepository
.GetByIdAsync(movimentacao.Id);
        ...
        [Fact(
            DisplayName = "Atualizar movimentação com sucesso  no banco de dados."
        ...
        public async Task AtualizarMovimentacaoComSucesso()
        {
            ...
            await _unitOfWork.MovimentacaoRepository
.UpdateAsync(movimentacao);
...
.GetByIdAsync(movimentacao.Id);
        ...
        [Fact(
                 DisplayName = "Excluir movimentação com sucesso  no banco de dados."          
        )]
...
.GetByIdAsync(movimentacao.Id);
        ...
        [Fact(
            DisplayName = "Consultar movimentações com sucesso  no banco de dados." 
        ...
        public async Task ConsultarMovimentacoesComSucesso()
        {
            ...
            var registros = await _unitOfWork.MovimentacaoRepository
.GetAllAsync();
        ...
        [Fact(
            DisplayName = "Obter movimentação por id com sucesso  no banco de dados.")]
